/// أنماط خرائط غوغل بصيغة JSON.
///
/// في `flutter_map` كان الوضع الليلي يُنفَّذ بقلب ألوان البلاطات عبر
/// `ColorFilter.matrix` — حيلة تقلب النصوص والأيقونات أيضاً فتبدو الخريطة
/// باهتة وغير مقروءة. خرائط غوغل تدعم التنسيق أصلاً، فنستخدمه بدل القلب.
class MapStyles {
  MapStyles._();
